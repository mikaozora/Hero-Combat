...
import static utils.Constant.UI.SkillButton.ItemBtn.HEIGHT_BUTTON;
import static utils.Constant.UI.SkillButton.ItemBtn.WIDTH_BUTTON;

public class ItempickButton {
    ...
    public ItempickButton(int x, int y, int rowIndex, GameStates state) {
        this.x = x;
        this.y = y;
